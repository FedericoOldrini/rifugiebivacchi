...
def add_overlay(
    ...
    try:
        ...
        try:
            ...
            title_font_bold = ImageFont.truetype("/System/Library/Fonts/Helvetica.ttc", title_font_size)
        except:
...
def main():
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("test_driver/screenshots"),
        help="Directory input con screenshot (default: test_driver/screenshots)"
    )
    parser.add_argument(
        "--output",
        type=Path,
